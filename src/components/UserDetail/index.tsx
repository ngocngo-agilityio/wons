...
const UserDetail = ({
  ...
  <section className="p-[0_30px_0] w-full gap-[5px_0]">
    <header className="m-[30px_0] flex flex-col sm:flex-row justify-between items-center">
      <div className="sm:flex gap-[0_20px]">
        <figure className="relative w-[128px] h-[128px]">
          <ImageFallback
        ...
        <figcaption className="flex flex-col justify-center text-center sm:text-left m-[20px_0] sm:m-0">
          <Text
            ...
            text={fullName}
          />
          <Text className="text-gray-900/80" size="md" as="p" text={role} />
        </figcaption>
      </div>
